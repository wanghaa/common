package com.xuliugen.common.i18n.impl;


import com.xuliugen.common.i18n.HierarchicalI18nService;
import com.xuliugen.common.i18n.I18nService;
...
public abstract class AbstractI18nService extends I18nServiceSupport
     ...
     * @param code the message code that we couldn't resolve and that we didn't
     ...
     * @param locale the Locale to resolve the code for (subclasses are encouraged
